        ...
        <div class="col-md-11">
            <div class="table-responsiveDos">
							<?=$this->Form->Create('Vivienda');?>
								...
								<?=$this->Form->submit('Guardar Cambios', array('class' => 'btn btn-primary') );?>
							<?=$this->Form->end();?>       
						</div>
        </div>
    </div>
...
<div id="dialogMantenciones" title="Detalle de Mantenciones" >
...
<a href="#mantenciones" id="openerMantenciones" class="btn btn-primary">Ver Mantenciones</a>
<!--<a name="mantenciones" id="mantenciones"></a>-->
<hr><hr><hr>
 <script>
